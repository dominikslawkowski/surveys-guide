...
const Privacy = () => {
  return (
    <div>
      ...
      <p>
        <strong>Effective date:</strong> 10/13/2023
      </p>
      <h3>1. Introduction</h3>
      <p>
        These Privacy Policy (“Privacy Policy”) apply to the use of the website
        and products provided by DOMINIK SŁAWKOWSKI (hereinafter also referred
        as “we” or “us”). Our registered office is at Zielona Góra, ul.
        Konstruktorów, nr 44, lok. 7, 65-119, registered no.: 666052215.
      </p>
      <p>
      ...
      <p>
        ...
        contact us at{' '}
        <a href="mailto:dominik.slawkowski@gmail.com">
      ...
      <p>
        Since we use LiveChat, Inc.’s Services you may be interested in
        reviewing their privacy policy available under the following links:
        <br />
        ...
        `s privacy policy:{' '}
        <a
          href="https://www.livechat.com/legal/privacy-policy/?ppg"
          target="_blank"
        >
